        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child:
              ...
              Container(
                margin: EdgeInsets.only(top:15,left: MediaQuery.of(context).size.width -60),
                child: TextButton(
              ...
              Container(
                margin: EdgeInsets.only(top: height * 0.15, left: 23),
                child: Text(
                  'Hi!',
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (!email.text.contains('@gmail.com')) {
                          ...
                          Navigator.of(context).pushNamed("toSignupScreen",
