                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Dismissible(
                              ...
                              key: Key(checkoutProvider.checkoutItems[index].productClass.title),
                              child: Column(
                                        ...
                                        Column(
                                          children: [
                                            Container(
                                              ...
                                              child: FittedBox(
                                                fit: BoxFit.contain,
                                                child: Image.network(checkoutProvider.checkoutItems[index].productClass
                                                    .imageUrl),
                                              ),
                                            ),
                                            InkWell(
                                                ...
                                                showModalBottomSheet(
                                                        ...
                                                        builder: (_) =>
                                                            SelectQuantity(
                                                                context,
                                                                index,
                                                                checkoutProvider.checkoutItems[index]
                                                                    .cartCounter))
                                                    .then((value) {
                                                  setState(() {});
                                                });
